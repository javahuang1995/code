...
('圣得西服',2999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,1);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('罗蒙西服',1999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,1);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('衫衫西服',3999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,1);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('金利来西服',4999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,1);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('韩版女装',199.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,2);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('雪地靴',299.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,2);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('欧版女装',3999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,2);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('女款手套',4999.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,2);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('佳能单反机',3998.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,3);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('金士顿优盘',299.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,3);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('日立硬盘',599.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,3);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('大水牛机箱',399.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,3);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('电脑桌',150.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,4);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('老板椅',199.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,4);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('空调',3599.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,4);

INSERT INTO t_product (name,price,pic,remark,xremark,commend,open,cid) VALUES
('电视',699.00,'study.jpg','这里是简单介绍','这里是详细介绍',true,true,4);
