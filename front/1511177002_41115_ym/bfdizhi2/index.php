...
setCookie('edfunc',"http://api.dayunbo.com:8096/vod/api_1.php")
//下面两行是可以修改的部分
...
<div class="main">
	...
	<div class="wrap">
		<div id="player" style="position:relative;z-index: 100;">
			<iframe scrolling="no" frameborder="0" align="center" name="apiwind" id="apiwind" rel="nofollow" border="0" style="background:#000; word-wrap: break-word; width: 960px; height: 700px" src="<?php echo $iframeurl;?>"></iframe>
		</div>
	</div>
